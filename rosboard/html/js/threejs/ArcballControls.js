 ...
 */
	...
	class ArcballControls extends THREE.EventDispatcher {
		...
		constructor( _camera, domElement, scene = null, allow_one_finger_control = true ) {

			super();

			this.allow_one_finger_control = allow_one_finger_control;
			...
			this.onPointerMove = event => {
				...
				if ( event.pointerType == 'touch' && this._input != INPUT.CURSOR ) {
					...
					switch ( this._input ) {
						...
						case INPUT.ONE_FINGER:
							//singleMove
							if (this.allow_one_finger_control) {
						...
						case INPUT.ONE_FINGER_SWITCHED:
							...
							if ( movement >= this._switchSensibility && this.allow_one_finger_control) {
